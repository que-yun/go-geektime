...
func (*Server_GRPC) Descriptor() ([]byte, []int) {
	return file_internal_conf_config_proto_rawDescGZIP(), []int{1, 1}
}
...
func (*Data_Redis) Descriptor() ([]byte, []int) {
	return file_internal_conf_config_proto_rawDescGZIP(), []int{2, 1}
}
...
var file_internal_conf_config_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x68, 0x65,
	0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x1a, 0x1e, 0x67, 0x6f,
	...
	,
	...
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xe5, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x39, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1d, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x61,
	...
	0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e,
	...
	0x52, 0x0c, 0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x14,
...
var file_internal_conf_config_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),         // 0: helloworld.api.Bootstrap
	(*Server)(nil),            // 1: helloworld.api.Server
	(*Data)(nil),              // 2: helloworld.api.Data
	(*Server_HTTP)(nil),       // 3: helloworld.api.Server.HTTP
	(*Server_GRPC)(nil),       // 4: helloworld.api.Server.GRPC
	(*Data_Database)(nil),     // 5: helloworld.api.Data.Database
	(*Data_Redis)(nil),        // 6: helloworld.api.Data.Redis
	(*duration.Duration)(nil), // 7: google.protobuf.Duration
}
var file_internal_conf_config_proto_depIdxs = []int32{
	1,  // 0: helloworld.api.Bootstrap.server:type_name -> helloworld.api.Server
	2,  // 1: helloworld.api.Bootstrap.data:type_name -> helloworld.api.Data
	3,  // 2: helloworld.api.Server.http:type_name -> helloworld.api.Server.HTTP
	4,  // 3: helloworld.api.Server.grpc:type_name -> helloworld.api.Server.GRPC
	5,  // 4: helloworld.api.Data.database:type_name -> helloworld.api.Data.Database
	6,  // 5: helloworld.api.Data.redis:type_name -> helloworld.api.Data.Redis
	7,  // 6: helloworld.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: helloworld.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: helloworld.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: helloworld.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
...
func file_internal_conf_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_conf_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_conf_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_conf_config_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
